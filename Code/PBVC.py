...
#------------------------------------------------------------------------
        ...
        img_pred = nib.load(f"/storage/data_4T/riccardoraciti/dataset/Flow_noResize/{file_name}_flow.nii.gz")
...
csv_file = '../Results/info_report_testSet_whit_target_noResize.csv'
